...
//////////////////////////////////////// RENUKA KALYANKAR  ////////////////////////////////////////////
public class SavingAccount extends Account implements Operable{

	int minBalance;
	static double interestRate=0.5; 
	static Scanner sc=new Scanner(System.in);
	
	public SavingAccount(int accountNum, String holderName, double balance,String password,String accType) {
